/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d266ce86f4d3873ef19ddecf685857d5)
// Runtime types generated with workerd@1.20260410.1 2026-04-13 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PlayerSupervisor" | "RoomSupervisor" | "AppRunner";
	}
	interface Env {
		LOADER: WorkerLoader;
		AI: Ai;
		PLAYER_SUPERVISOR: DurableObjectNamespace<import("./src/index").PlayerSupervisor>;
		ROOM_SUPERVISOR: DurableObjectNamespace<import("./src/index").RoomSupervisor>;
